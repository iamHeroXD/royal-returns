    ...
    <footer className="bg-navy-950 text-slate-300 border-t border-navy-900 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-navy-900">
              ...
              {companyData.whatsAppUrl && (
                <div className="flex items-center gap-2.5 pt-1">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hover:text-emerald-400 transition-colors text-emerald-400 text-xs font-semibold"
                  >
                    Message on WhatsApp
                  </a>
                </div>
          ...
          {/* Col 2: Quick Links */}
          <div>
            <h3 className="text-white font-extrabold text-xs tracking-widest uppercase mb-4 border-b border-navy-900 pb-2">
              Company
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm mb-4">
              <li>
                <Link href="/emi-calculator" className="hover:text-gold-400 transition-colors font-semibold text-gold-400">EMI Calculator</Link>
              </li>
              <li>
        ...
        <div className="py-6 text-xs text-slate-400 leading-relaxed border-b border-navy-900">
          <p>
