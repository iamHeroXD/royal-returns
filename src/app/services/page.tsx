    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-10">
      ...
      <div className="max-w-3xl space-y-3">
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed">
          Royal Returns assists individuals and business clients across property financing, personal & commercial loans, fixed and recurring deposits, and financial profile assessment.
        </p>
      </div>

      <ServiceCategoryTabs services={servicesData} />

      <div className="p-6 bg-slate-100 border border-slate-200 rounded-2xl text-xs text-slate-600 space-y-2">
