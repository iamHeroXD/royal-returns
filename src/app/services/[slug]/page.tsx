...
export default function ServiceDetailPage({ params }: ServicePageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-12">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-navy-950 to-navy-900 text-white rounded-3xl p-8 md:p-12 border border-navy-800 shadow-2xl relative overflow-hidden">
        <div className="max-w-3xl space-y-4 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-royal-900/80 text-gold-400 font-bold text-xs uppercase tracking-wider border border-royal-700/50">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4">
            <a
              href="#enquiry-form"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-royal-600 to-royal-700 hover:from-royal-500 hover:to-royal-600 text-white font-bold text-sm px-6 py-3.5 rounded-xl shadow-lg transition-all"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-xl md:text-2xl font-bold text-navy-900">What this solution can help with</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {service.useCases.map((useCase, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 text-slate-700 text-sm">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-xl md:text-2xl font-bold text-navy-900">Factors influencing eligibility</h2>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h2 className="text-xl md:text-2xl font-bold text-navy-900">Typical Documentation Checklist</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {service.typicalDocuments.map((doc, idx) => (
                <div key={idx} className="flex items-start gap-2.5 p-3 rounded-xl bg-slate-50 border border-slate-100 text-slate-700 text-xs font-medium">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm space-y-6">
            <h2 className="text-xl md:text-2xl font-bold text-navy-900">How the process works</h2>
            <div className="space-y-4">
              {service.processSteps.map((step, idx) => (
                <div key={idx} className="flex items-start gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                  ...
                  <div>
                    <h3 className="font-bold text-navy-900 text-sm">Step {idx + 1}</h3>
            ...
            <div className="p-4 bg-slate-100 rounded-xl text-xs text-slate-600 leading-relaxed">
        ...
        <div className="lg:col-span-4" id="enquiry-form">
          <div className="sticky top-24 space-y-6">
            ...
            <div className="bg-navy-950 text-white rounded-2xl p-6 border border-navy-800 space-y-3">
              <div className="flex items-center gap-2 text-gold-400 font-bold text-xs uppercase tracking-wider">
                <ShieldCheck className="w-4 h-4" />
                <span>Royal Returns Guarantee</span>
              </div>
